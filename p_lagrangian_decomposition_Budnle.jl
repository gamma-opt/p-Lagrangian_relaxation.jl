...
function p_Lagrangian_decomposition_bundle(p, number_of_scenarios, number_of_continuos_decision_variables, number_of_integer_decision_variables, number_of_constrains, Qdensity, number_of_iterations)
    ...
    subproblems = LD_RNDMT_problem_generation(p, number_of_scenarios, number_of_continuos_decision_variables, number_of_integer_decision_variables, number_of_constrains, Qdensity)
        ...
        @sync @distributed for s in 1 : number_of_scenarios
            ...
            @objective( subproblems[s], Max,
                (1/number_of_scenarios) *
                    ...
                    + sum( subproblems[s][:x][i] * objective_fs[s][1, i]  for i = 1:number_of_continuos_decision_variables)
