...
function dynamic_precision_based_Lagrangian_decomposition_bundle(precision_p, number_of_scenarios, number_of_integer_decision_variables, number_of_continuous_decision_variables, number_of_constraints, Qdensity, number_of_iterations, center_of_gravity_inital_value, dynamic_precision_algorithm_iteration)

    number_of_the_serious_steps = 0

    # generating the parameters
    constraint_Qs, constraint_fs, objective_Qs, objective_fs, objective_c, x_boundaries, y_boundaries = parameters_generation(number_of_scenarios, number_of_integer_decision_variables, number_of_continuous_decision_variables, number_of_constraints, Qdensity)
    ...
    subproblems = dynamic_precision_based_LD_RNDMT_problem_generation(precision_p, number_of_scenarios, number_of_integer_decision_variables, number_of_continuous_decision_variables, number_of_constraints, Qdensity)
    ...
    #d = ((dynamic_precision_algorithm_iteration == 1) ? 10 : (10/dynamic_precision_algorithm_iteration))
    ...
    number_of_iteration_for_checking = 4
...
function dynamic_precision_based_Lagrangian_decomposition_bundle_random_center(precision_p, number_of_scenarios, number_of_integer_decision_variables, number_of_continuous_decision_variables, number_of_constraints, Qdensity, number_of_iterations)
    ...
    eps_stop = 100
    #eps_stop = ((dynamic_precision_algorithm_iteration == 1) ? 10 : 1e-1) # stopping criteria
    number_of_iteration_for_checking = 4
